...
export const LoginPage: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (username === 'ReflectiveSessionsAdmin' && password === 'RSMVS01') {
        navigate('/admin');
      } else {
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-slate-500">
                <input type="checkbox" className="mr-2 rounded border-slate-300 text-[#4DA3FF] focus:ring-[#4DA3FF]" />
                Remember me
              </label>
              <a href="#" className="text-[#4DA3FF] hover:underline font-medium">Forgot password?</a>
            </div>
